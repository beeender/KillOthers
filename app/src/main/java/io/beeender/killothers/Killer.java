...
public class Killer {
     ...
     */
    public synchronized static void tryKill(Context context) {
        ...
        try {
            ...
            // We have seen issues with context not being fully ready with things like getFilesDir() not working.
